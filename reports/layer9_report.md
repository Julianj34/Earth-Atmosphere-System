...
**Run:** 2026-08-25T20:53:03.769595Z
...
## Uncertain Checks
- **V_storm_atmosphere** (storm_validation): EONET open storms=7. L3=0.178, active_thunderstorms=False
...
- ✅ **V_consistency_seasonal**: seasonal_transition_state: preparation > 0.45 und downstream < 0.35
  ...
  - Beobachtet: prep=0.609, downstream=0.255
