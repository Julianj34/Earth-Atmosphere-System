...
**Run:** 2026-08-31T23:57:37.883255Z
...
## Uncertain Checks
- **V_storm_atmosphere** (storm_validation): EONET open storms=7. L3=0.196, active_thunderstorms=False
...
- ✅ **V_kp_consistency**: Modell-Kp und NOAA-Kp im gleichen Zeitfenster konsistent
  ...
  - Beobachtet: model_current=0.0  vs  noaa_current=1.0  →  |Δ|=1.00
...
- ✅ **V_consistency_seasonal**: seasonal_transition_state: preparation > 0.45 und downstream < 0.35
  ...
  - Beobachtet: prep=0.583, downstream=0.247
