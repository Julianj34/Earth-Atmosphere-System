...
**Run:** 2026-08-20T15:00:31.250063Z
**Snapshots analysiert:** 278
**Vollständige Tagespaare:** 46

## System-State Häufigkeit

- `seasonal_transition_state` — 260× (93.5%)
...
Coverage: 260/278 Snapshots

### Aktuelle Operator-Rangliste

- **resonance_model**: 0.440 — modellierter nicht-geometrischer Anteil über Cavity-Geometrie hinaus
- **thermal**: 0.423 — moderate thermische Vorbereitung vorhanden
- **ionization**: 0.369 — moderate ionosphärische Modulation
- **geomagnetic**: 0.221 — ruhige geomagnetische Bedingungen
- **electric**: 0.219 — GEC nahe Referenz, keine elektrische Aktivierung  ⚠️ confounded_circular
