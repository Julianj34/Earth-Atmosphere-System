...
**Run:** 2026-07-26T15:36:11.418933Z
**Snapshots analysiert:** 179
**Vollständige Tagespaare:** 24

## System-State Häufigkeit

- `seasonal_transition_state` — 164× (91.6%)
- `cavity_condition_shift_state` — 6× (3.4%)
...
Coverage: 161/179 Snapshots

### Aktuelle Operator-Rangliste

- **resonance_model**: 0.578 — modellierter nicht-geometrischer Anteil über Cavity-Geometrie hinaus
...
- **ionization**: 0.346 — Ionosphärenstörung: starker Strahlungseffekt auf Ausbreitung
