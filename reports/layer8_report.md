...
**Run:** 2026-08-07T00:58:31.918107Z
**Snapshots analysiert:** 223
**Vollständige Tagespaare:** 33

## System-State Häufigkeit

- `seasonal_transition_state` — 208× (93.3%)
- `cavity_condition_shift_state` — 6× (2.7%)
- `anomalous_resonance_state` — 6× (2.7%)
- `normal_background_state` — 2× (0.9%)
- `geomagnetic_disturbance_state` — 1× (0.4%)
...
Coverage: 205/223 Snapshots

### Aktuelle Operator-Rangliste

- **thermal**: 0.450 — moderate thermische Vorbereitung vorhanden
- **resonance_model**: 0.408 — modellierter nicht-geometrischer Anteil über Cavity-Geometrie hinaus
- **ionization**: 0.286 — ruhige Ionosphäre, minimaler Strahlungseffekt
- **electric**: 0.266 — GEC nahe Referenz, keine elektrische Aktivierung  ⚠️ confounded_circular
- **cross_layer_activation**: 0.225 — schwache Übergangsspannung bei L2_to_L3  ⚠️ confounded_circular
- **geomagnetic**: 0.109 — ruhige geomagnetische Bedingungen

### Operator ↔ ΔL3 Korrelation

- electric: r = +0.579  ⚠️ **confounded_circular** — Operator enthält L3, kein unabhängiger Prädiktor
- resonance_model: r = +0.452
- ionization: r = -0.154
- thermal: r = -0.142
- geomagnetic: r = +0.054
...
- **Evidenz:** Pearson L5_evening vs L6_evening = +0.810 über 33 Abende.
...
- **Status:** confound_blocked (confounded_circular) — nicht promotbar, nur exploratorisch
- **Evidenz:** Pearson electric_operator vs ΔL3 = +0.579.
