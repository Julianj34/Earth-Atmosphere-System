...
**Run:** 2026-07-26T10:25:32.019611+00:00  
**Snapshots:** 177  
...
| H_meso_conv | L2p5 | regional | 0.061 | proxy |
...
Makro-Vorbereitung (`H_macro_ocean`) ist der höchste physische Score, Mikro-Aktivierung (`H_micro_storm`) der niedrigste. Die Meso-Skala ist instrumentiert (Wolken-Uebergangsproxy, `confound_type=proxy` bis echtes OLR zurueckkommt), aber die Historie (n=7) ist noch zu klein fuer eine belastbare Kopplungsschaetzung.
...
|---|---|---|---|---|
| H_macro_ocean→H_meso_conv | top_down_constraint | -0.572 | 7 | moderate_low_n |
| H_meso_conv→H_micro_storm | bottom_up_aggregation | -0.549 | 6 | moderate_low_n |
| H_micro_storm→H_field_gec | bottom_up_aggregation | +0.531 | 177 | moderate |
| H_field_gec→H_field_reso | field_feedback | +0.499 | 177 | moderate |
